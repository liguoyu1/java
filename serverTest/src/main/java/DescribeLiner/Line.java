...
//http://wenwen.sogou.com/z/q382823846.htm
//package com.my.study.algorithm.leastSquareMethod;

/**
 * @author Guoyu Li
 * @data-time  2016.12.05
 */
...
public class Line {
	 ...
	 */
	public Line(double[] x, double[] y, int n) {
	 ...
	 *            The order of polynomial
	 */
	public Line(double[] x, double[] y, double[] weight, int n) {
	...
	public static void main(String[] args) {
		Line eastSquareMethod = new Line(
		...
		System.out.println(eastSquareMethod.fit(5));

		Line eastSquareMethod2 = new Line(
				new double[] { 0.5, 1.0, 1.5, 2.0, 2.5, 3.0 }, new double[] {
						1.75, 2.45, 3.81, 4.8, 7.0, 8.6 }, 2);
		System.out.println(eastSquareMethod2.solve(8.69));
